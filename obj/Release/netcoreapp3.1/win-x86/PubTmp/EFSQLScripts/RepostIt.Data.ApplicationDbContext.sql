...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200502023056_initialCreateSchema')
BEGIN
...
BEGIN
    CREATE TABLE [community] (
        ...
        [communityType] nvarchar(max) NULL,
...
BEGIN
    CREATE TABLE [posts] (
        [id] int NOT NULL IDENTITY,
        [showTitle] nvarchar(max) NULL,
        [communityId] int NOT NULL,
        [url] nvarchar(max) NULL,
        [description] nvarchar(max) NULL,
        [name] nvarchar(max) NULL,
        CONSTRAINT [PK_posts] PRIMARY KEY ([id]),
        CONSTRAINT [FK_posts_community_communityId] FOREIGN KEY ([communityId]) REFERENCES [community] ([Id]) ON DELETE CASCADE
    );
END;
...
BEGIN
    ...
    VALUES (N'20200502023056_initialCreateSchema', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200502131607_addedComment')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200502131607_addedComment', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200502145254_fixedComment')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200502145254_fixedComment', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200504204503_likeAddedAndUpdateComment')
BEGIN
    ALTER TABLE [community] ADD [name] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200504204503_likeAddedAndUpdateComment', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200504234843_addDislike')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200504234843_addDislike', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505025447_AdditionalSeed')
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'communityType', N'name') AND [object_id] = OBJECT_ID(N'[community]'))
        SET IDENTITY_INSERT [community] ON;
    INSERT INTO [community] ([Id], [communityType], [name])
    VALUES (200, N'Funny', N'Admin'),
    (201, N'Sad', N'Admin'),
    (202, N'Trololo', N'Admin'),
    (203, N'Sport', N'Admin');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'communityType', N'name') AND [object_id] = OBJECT_ID(N'[community]'))
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505025447_AdditionalSeed')
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'id', N'postId', N'username') AND [object_id] = OBJECT_ID(N'[likes]'))
        SET IDENTITY_INSERT [likes] ON;
    INSERT INTO [likes] ([id], [postId], [username])
    VALUES (300, 100, N'Admin'),
    (301, 101, N'Admin'),
    (302, 103, N'Admin'),
    (303, 104, N'Admin');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'id', N'postId', N'username') AND [object_id] = OBJECT_ID(N'[likes]'))
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505025447_AdditionalSeed')
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'id', N'communityId', N'description', N'name', N'showTitle', N'url') AND [object_id] = OBJECT_ID(N'[posts]'))
        SET IDENTITY_INSERT [posts] ON;
    INSERT INTO [posts] ([id], [communityId], [description], [name], [showTitle], [url])
    VALUES (100, 200, N'2020 was awesome', N'Admin', N'Office MEME', N'../img/office.jpg'),
    (101, 200, N'Big COVID-19 Bang', N'Admin', N'Sheldon', N'../img/sheldon.jpg'),
    (102, 200, N'Magic', N'Admin', N'WOW', N'../img/spmagic.jpg'),
    (104, 200, N'Awesome', N'Admin', N'Great MEME', N'../img/spsqp.png');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'id', N'communityId', N'description', N'name', N'showTitle', N'url') AND [object_id] = OBJECT_ID(N'[posts]'))
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200505025447_AdditionalSeed', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505132132_fixedSeedImages')
BEGIN
    UPDATE [posts] SET [url] = N'https://i.kym-cdn.com/photos/images/original/001/488/398/944.jpeg'
    WHERE [id] = 100;
    SELECT @@ROWCOUNT;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505132132_fixedSeedImages')
BEGIN
    UPDATE [posts] SET [url] = N'https://starecat.com/content/wp-content/uploads/all-of-a-sudden-everybody-has-become-sheldon-big-bang-theory-coronavirus.jpg'
    WHERE [id] = 101;
    SELECT @@ROWCOUNT;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505132132_fixedSeedImages')
BEGIN
    UPDATE [posts] SET [url] = N'https://i.redd.it/2d6a36bq6mw41.png'
    WHERE [id] = 104;
    SELECT @@ROWCOUNT;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200505132132_fixedSeedImages', N'3.1.3');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200505140013_newmigration')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200505140013_newmigration', N'3.1.3');
END;
